...
export const metadata: Metadata = { title: "Elite Auto Studio | Mobile Car Detailing Belgium", description: "Premium mobile car detailing at your home or workplace across Brussels and Brabant." };
