...
const Hero = () => <section className="hero" id="home">
  <div className="hero__inner shell">
    <Reveal className="hero__masthead">
      ...
      <div className="hero__booking-row"><p><strong>Stay home. We come to you.</strong><span>Studio-quality detailing without the drive, waiting room or disruption.</span></p><div className="hero__actions"><PrimaryLink href="#contact">Dispatch a team</PrimaryLink><a href="#services">Explore services <ArrowDownIcon aria-hidden="true" size={13} weight="bold" /></a></div></div>
    </Reveal>
